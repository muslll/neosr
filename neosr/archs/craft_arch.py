...
class craft(nn.Module):
    ...
    def calculate_rpi_v_sa(self):
        ...
        biases_h = torch.stack(torch.meshgrid([position_bias_h, position_bias_w], indexing='ij'))
        ...
        position_bias_h = torch.arange(1 - H_sp, H_sp)
        position_bias_w = torch.arange(1 - W_sp, W_sp)
        biases_v = torch.stack(torch.meshgrid([position_bias_h, position_bias_w], indexing='ij'))
