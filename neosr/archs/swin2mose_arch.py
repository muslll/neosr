...
class MoE(nn.Module):
    ...
    def forward(self, x, loss_coef=1e-2):
        ...
        """
        xg = self.x_gate(x).squeeze(1) if self.x_gating is not None else x.mean(1)
...
class WindowAttention(nn.Module):
    ...
    def lepe_pos(self, v):
        ...
        return lepe.permute(0, 1, 3, 2).contiguous()
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = MoE(input_size=dim, output_size=dim, hidden_size=mlp_hidden_dim)
...
class swin2mose(nn.Module):
    """Swin2-MoSE:
    https://github.com/hachreak/swin2-mose
