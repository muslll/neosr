...
class AdanLKDN(Optimizer):
    ...
    Arguments:
        ...
        https://openaccess.thecvf.com/content/CVPR2023W/NTIRE/papers/Xie_Large_Kernel_Distillation_Network_for_Efficient_Single_Image_Super-Resolution_CVPRW_2023_paper.pdf
    """
